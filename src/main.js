...
app.use(store).use(router).use(i18n).use(PerfectScrollbar).use(VueNouislider).use(Maska)
    .use(ClientTable).use(ServerTable)
    .use(vue3JsonExcel).use(VueFormWizard).use(head).mount('#app');
