<template>
    <div>
        ...
        <div class="app-settings" :class="{ active: isOpen }">
            <a href="javascript:" id="setting-button" class="setting" @click="isOpen = !isOpen">
                <h5 class="mb-0">
                    <svg
            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <div class="btn-group-toggle row mx-0">
                    ...
                    <div class="text-color radio-primary col-5 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="large-boxed" v-model="$store.state.layout_style" class="custom-control-input" value="large-boxed-layout" @change="setLayoutStyle" />
                        <label class="custom-control-label" for="large-boxed">Large box</label>
                    </div>
